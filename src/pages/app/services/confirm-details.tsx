...
import { mappedWorkTypeMapResponse } from '@/mappers/mapped-work-type-response';
      ...
      <CardContent>
        <div className='space-y-5'>
          ...
          <div className='space-y-2'>
            ...
            <p className='text-sm'>{mappedWorkTypeMapResponse[service.workType]}</p>
          </div>
          ...
          <div className='space-y-2'>
            ...
            <p className='text-sm'>
              {Number(service.deadline) > 1 ? (
                ...
                <span>
                  {differenceInDaysFromToday(service.deadline)} dia(s)
                </span>
              )}
            </p>
          </div>
